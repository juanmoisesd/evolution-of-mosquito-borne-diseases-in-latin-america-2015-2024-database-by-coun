# analysis.py — Evolution of Mosquito-Borne Diseases in Latin America 2015-2024: Database by Country and Disease
...
keywords = ['Latin America', 'dengue', 'Zika', 'COVID-19']
...
print(f"Dataset: Evolution of Mosquito-Borne Diseases in Latin Amer")
print(f"DOI: 10.5281/zenodo.18880833")
...
fig.suptitle("Evolution of Mosquito-Borne Diseases in Latin America 2015-2", fontsize=11, fontweight="bold")
...
print(f"""
Citation:
de la Serna Tuya, Juan Moisés (2026). Evolution of Mosquito-Borne Diseases in Latin America 2015-2024: Datab. Zenodo. https://doi.org/10.5281/zenodo.18880833
""")
